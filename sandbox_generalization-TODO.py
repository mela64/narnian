...
ag.behav.add_transit("recording3", "recording4", action="record", args={"stream_hash": "envir:3sinlfla", "steps": n*1500})
ag.behav.add_transit("recording4", "recording5", action="record", args={"stream_hash": "envir:squarehfha", "steps": n*1500})
ag.behav.add_transit("recording5", "recording6", action="record", args={"stream_hash": "envir:squarehfla", "steps": n*1500})
ag.behav.add_transit("recording6", "recording7", action="record", args={"stream_hash": "envir:squarelfha", "steps": n*1500})
ag.behav.add_transit("recording7", "recording8", action="record", args={"stream_hash": "envir:squarelfla", "steps": n*1500})
...
ag.behav.add_transit("ready_to_ask", "asked_gen", action="ask_gen",
                     args={"du_hash": "<playlist>",  "dhat_hash": "<playlist>", "ask_steps": n*1500})
