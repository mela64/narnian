...
ag.behav.add_transit("got_agents", "recording1", action="record", args={"stream_hash": "envir:sin", "steps": 20})
ag.behav.add_transit("recording1", "recording2", action="record", args={"stream_hash": "envir:square", "steps": 20})
ag.behav.add_transit("recording2", "playlist_ready", action="set_pref_streams",
                     args={"stream_hashes": ["teacher:recorded1", "teacher:recorded2"], "repeat": 1})
...
ag.behav.add_state_action("done_gen", action="eval", args={"stream_hash": "<playlist>", "what": "y", "steps": 10})
