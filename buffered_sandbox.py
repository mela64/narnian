...
from basic.basic_streams import Sin, Square, Random, CombSin
...
Stream.register(name="combsin", stream_class=CombSin, stream_class_args={"f_cap": 0.3, "c_cap": 1., "order": 3, "delta": 0.1})
...
env.add_stream(Stream.create(name="combsin", creator="envir"))
...
ag.behav.add_transit("got_agents", "recording1", action="record", args={"stream_hash": "envir:combsin", "steps": 5000})
# ag.behav.add_transit("recording1", "recording2", action="record", args={"stream_hash": "envir:square", "steps": 5000})
ag.behav.add_transit("recording1", "playlist_ready", action="set_pref_streams",
                     args={"stream_hashes": ["teacher:recorded1"]})
...
ag.behav.add_transit("done_learn", "asked_gen", action="ask_gen",
                     args={"du_hash": "<playlist>",  "dhat_hash": "<playlist>", "ask_steps": 3000})
ag.behav.add_transit("asked_gen", "done_gen", action="done_gen")
ag.behav.add_state_action("done_gen", action="eval", args={"stream_hash": "<playlist>", "what": "y", "steps": 2000})
