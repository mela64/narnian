...
from basic.basic_streams import Square, CombSin3, CombSin6
...
Stream.register(name="3sin", stream_class=CombSin3, stream_class_args={"f_cap": 0.06, "c_cap": 1., "delta": 0.1})
Stream.register(name="6sin", stream_class=CombSin6, stream_class_args={"f_cap": 0.06, "c_cap": 0.5, "delta": 0.1})

# adding streams to the environment
env.add_stream(Stream.create(name="square", creator="envir"))
env.add_stream(Stream.create(name="3sin", creator="envir"))
env.add_stream(Stream.create(name="6sin", creator="envir"))
...
ag.behav.add_transit("recording2", "playlist_ready", action="set_pref_streams",
                     args={"stream_hashes": ["teacher:recorded1", "teacher:recorded2"], "repeat": 30})
